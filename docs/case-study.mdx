...
- distinguish retained access from demonstrated necessity; and
- keep the high-risk live workflow optional and explicitly bounded.

The next meaningful product milestone is real-world feedback from GitHub App
maintainers: which routes block adoption, which permission diffs improve
reviews, and whether scenario attribution changes how teams discuss coverage.
That evidence should guide catalog growth before feature count does.
