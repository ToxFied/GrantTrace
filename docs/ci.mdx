...
Structured reports omit free-form reasons, scenario names, concrete URLs and
paths, errors, and credentials. Permission identifiers remain visible because
they are the machine-readable contract, including user-supplied manual-keep
keys. Do not encode identities or secrets in a permission name.
